...
<html>
<head>
  <title>Bootstrap Plus Demo</title>
  ...
  .bs-docs-section{margin-top:2em}
  ...
  #built-with-bootstrap a:hover span {
    color: #FFF;
  }
  </style>
</head>
...
<bsp:container>
  <bsp:pageHeader id="banner">
    <bsp:row>
      <bsp:col col-size="lg-12, md-12, sm-12">
        <h1>
          <strong>SGO</strong> Bootstrap
        </h1>
        <p class="lead">A <a href="http://getbootstrap.com" target="_blank">Bootstrap</a> theme built for <a href="http://stevegood.org" target="_blank">stevegood.org</a> <span class="text-muted small">(but you can use it too!)</span></p>
      </bsp:col>
    </bsp:row>
  </bsp:pageHeader>
...
================================================== -->
  <div class="bs-docs-section">
    ...
    <bsp:row>
      <bsp:col col-size="lg-6">
        <p class="bs-component">
          <bsp:defaultButton>Default</bsp:defaultButton>
          <bsp:primaryButton>Primary</bsp:primaryButton>
          <bsp:successButton>Success</bsp:successButton>
          <bsp:infoButton>Info</bsp:infoButton>
          <bsp:warningButton>Warning</bsp:warningButton>
          <bsp:dangerButton>Danger</bsp:dangerButton>
        </p>

        <p class="bs-component">
          <bsp:defaultButton class="disabled">Default</bsp:defaultButton>
          <bsp:primaryButton class="disabled">Primary</bsp:primaryButton>
          <bsp:successButton class="disabled">Success</bsp:successButton>
          <bsp:infoButton class="disabled">Info</bsp:infoButton>
          <bsp:warningButton class="disabled">Warning</bsp:warningButton>
          <bsp:dangerButton class="disabled">Danger</bsp:dangerButton>
        </p>
  ...
  <footer>
    <bsp:row>
      <div class="col-lg-12">
        ...
        <p>Made by Steve Good. Contact him at <a href="mailto:steve@stevegood.org">stevestevegood.org</a>.</p>
